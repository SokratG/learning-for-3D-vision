...
def get_args_parser():
    ...
    parser.add_argument('--max_iter', default=15000, type=int) # 100000
...
def fit_mesh(mesh_src, mesh_tgt, args):
    ...
    render_pmesh(mesh_src, output_path='images/mesh_opt.gif')
    render_pmesh(mesh_tgt, output_path='images/mesh_gt.gif')
    print('Done!')
...
def fit_pointcloud(pointclouds_src, pointclouds_tgt, args):
    ...
    render_pc(pointclouds_src, output_path='images/pc_opt.gif')
    render_pc(pointclouds_tgt, output_path='images/pc_gt.gif')
    print('Done!')
...
def fit_voxel(voxels_src, voxels_tgt, args):
    ...
    render_voxels(voxels_src, output_path='images/voxels_opt.gif')
    render_voxels(voxels_tgt, output_path='images/voxels_gt.gif')
    print('Done!')
