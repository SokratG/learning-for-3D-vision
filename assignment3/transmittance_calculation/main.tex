...
\begin{studentsolution}
    T(x, x_{t_i}) = T(x, x_{t_{i-1}}) \cdot e^{-\sigma_{t_{i-1}} \cdot \Delta{t_{i-1}}}

    T(y1, y2) = e^{-2} = 0.135
    
    T(y2, y4) = T(y2, y3) \cdot T(y3, y4) = e^{-0.5} \cdot e^{-30} = $5.6756852e-14$
    
    T(x, y4) = T(x, y1) \cdot T(y1, y2) \cdot T(y2, y3) \cdot T(y3, y4) = e^{0} \cdot e^{-2} \cdot e^{-0.5} \cdot e^{-30} = $7.6812047e-15$
    
    T(x, y3) = e^{0} \cdot e^{-2} \cdot e^{-0.5} = 0.082
\end{studentsolution}
