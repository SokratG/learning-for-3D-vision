...
def train_points(
    ...
    for epoch in range(0, cfg.training.num_epochs):
        ...
        for idx in t_range:
            ...
            # manifold loss with l2-norm: Implicit Geometric Regularization for Learning Shapes
            loss = distances.norm(dim=-1).mean() # TODO (Q6): Point cloud SDF loss on distances
            point_loss = loss
