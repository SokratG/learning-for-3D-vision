...
def setup_optimizer(gaussians: Gaussians):
    ...
    parameters = [
        # {'params': [gaussians.pre_act_opacities], 'lr': 0.0025, "name": "opacities"},
        # {'params': [gaussians.pre_act_scales], 'lr': 0.002, "name": "scales"},
        # {'params': [gaussians.colours], 'lr': 0.045, "name": "colours"},
        # {'params': [gaussians.means], 'lr': 0.00075, "name": "means"},

        # {'params': [gaussians.pre_act_opacities], 'lr': 0.001, "name": "opacities"},
        # {'params': [gaussians.pre_act_scales], 'lr': 0.0015, "name": "scales"},
        # {'params': [gaussians.colours], 'lr': 0.035, "name": "colours"},
        # {'params': [gaussians.means], 'lr': 0.00045, "name": "means"},

        {'params': [gaussians.pre_act_opacities], 'lr': 0.00085, "name": "opacities"},
        {'params': [gaussians.pre_act_scales], 'lr': 0.001, "name": "scales"},
        {'params': [gaussians.colours], 'lr': 0.02, "name": "colours"},
        {'params': [gaussians.means], 'lr': 0.00015, "name": "means"},
    ]
...
def run_training(args):
    ...
    imageio.mimsave(viz_gif_path_1, viz_frames, fps=15)
    ...
    # Saving renderings
    imageio.mimsave(viz_gif_path_2, frames, fps=15)
...
def get_args():
    ...
    parser.add_argument(
        "--gaussians_per_splat", default=1024, type=int, # -1
        help=(
    ...
    parser.add_argument(
        "--num_itrs", default=650, type=int, # 1000
