...
def optimize_nerf(
    ...
    dim = 512
    upscaler = torchvision.transforms.Resize(size=(dim, dim), interpolation=FT.InterpolationMode.BILINEAR)
    ...
    for epoch in range(max_epoch):
        ...
        for data in train_loader:
            ...
            ### YOUR CODE HERE ###
            rgb_pred_up = upscaler(pred_rgb)
            latents = sds.encode_imgs(rgb_pred_up)
...
if __name__ == "__main__":
    ...
    # parser.add_argument('--textureless_ratio', type=float, default=0.1, help="textureless ratio")
