...
def create_parser():
    ...
    parser.add_argument('--batch_size', type=int, default=10, help='The number of points in a batch.') # 32
    parser.add_argument('--num_workers', type=int, default=2, help='The number of threads to use for the DataLoader.')
